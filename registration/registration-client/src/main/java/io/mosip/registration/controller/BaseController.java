...
//	boolean isBioPageEnable(String pageId,String individualType) {
//		
//		if(individualType.equalsIgnoreCase(RegistrationConstants.indBiometrics)) {
//			
//			List<String> uiSchemaBioAttributes = getSchemaFieldBioAttributes(RegistrationConstants.indBiometrics);
//			
//		}else if(individualType.equalsIgnoreCase(RegistrationConstants.parentBiometrics)) {
//			
//			List<String> uiSchemaBioAttributes = getSchemaFieldBioAttributes(RegistrationConstants.parentBiometrics);
//		}
//		return false;
//	}
//	
//	boolean getEnabledBioAttributes(String pageId) {
//		
//		return false;
//	}
}